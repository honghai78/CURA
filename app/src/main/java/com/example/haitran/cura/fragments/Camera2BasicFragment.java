...
//    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.buttonClick).setOnClickListener(this);
...
//                }
                    ...
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                            ...
                            try {
                                ...
                                configFlash(mPreviewRequestBuilder, configFlash);
    ...
    private void captureStillPicture() {
        try {
            ...
            captureBuilder.set(CaptureRequest.CONTROL_AF_MODE,
                    CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_PICTURE);
            configFlash(captureBuilder, configFlash);
            ...
            case R.id.imageView2:
            {
                ...
                switch (configFlash){
                    case 1:
                        ...
                        configFlash(mPreviewRequestBuilder, -1);
                        Toast.makeText(getActivity(), "on to off", Toast.LENGTH_SHORT).show();
                        break;
                    case -1:
                        configFlash=0;
                        flash.setImageResource(R.drawable.flashauto);
                        configFlash(mPreviewRequestBuilder, 0);
                    ...
                    case 0:
                        ...
                        configFlash(mPreviewRequestBuilder, 1);
                        Toast.makeText(getActivity(), "auto to on", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        configFlash=0;
                        flash.setImageResource(R.drawable.flashauto);
    ...
    private void configFlash(CaptureRequest.Builder requestBuilder, int config) {
        if (mFlashSupported) {
            switch (config){
                case 0:
